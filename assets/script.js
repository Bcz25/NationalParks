...
const forecastGreeting = document.getElementById('forecast-title')
...
searchButton.addEventListener('click', getParkPhotos);
  ...
  function forecastWeather(){
    ...
    const parkLocations = {
      ...
      'Congaree': { latitude: '33.78', longitude: '-80.78' },
      ...
      'Hawaiʻi volcanoes': { latitude: '19.38', longitude: '-155.2' },
    ...
    if (parkLoc) {
      ...
      .then(data => {
          ...
          forecastGreeting.innerHTML = '';
          forecastGreeting.appendChild(forecastTitle);
  ...
  function createForecastCard(forecast) {
      ...
      card.classList.add('card', 'column', 'is-one-quater', 'five-day');
